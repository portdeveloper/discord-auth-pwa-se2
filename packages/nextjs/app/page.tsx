...
import { DiscordRoles } from "~~/components/scaffold-eth/DiscordRoles";
      ...
      <div className="px-5 w-full max-w-4xl flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          <FeatureCard
            ...
            title="Quick Start"
            description="Use discord auth with roles to quickly get started using Scaffold-ETH 2."
          />
          <FeatureCard
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 bg-base-100 rounded-lg p-4 px-8">
